...
<!-- #region {"slideshow": {"slide_type": "fragment"}} -->
* The most noteworthy development is that the (standardized) cost of incidents is staying constant, while the (standardized) volume spilled is decreasing.
<!-- #endregion -->
...
<!-- #region {"slideshow": {"slide_type": "subslide"}} -->
* But what really stands out is that it seems improvements are being made for crude, but not so much for RPP and HVL
<!-- #endregion -->
