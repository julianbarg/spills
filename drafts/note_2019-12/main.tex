...
\section{}	
	...
	\texttt{
		\begin{itemize}
			\item Pivor to vicarious learning.
			\item Emphasize importance of peer performance, events for improvements, with mechanism being aspiration level.
			\item Regulations.
			\item Emphasize importance of deliberate resource commitments where relationship to profitability is not clear.
		\end{itemize}
		}
